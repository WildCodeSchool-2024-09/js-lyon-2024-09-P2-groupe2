    ...
    <section className="mainAbout">
      ...
      <div className="textesEtSousTitre">
        ...
        <p id="text">
          ...
          artistic treasures of the Metropolitan Museum of New York. Our mission
          is simple: to make the incredible richness of this iconic museum's
          free database accessible to all. By bringing artworks from different
          eras and cultures to your fingertips, WeArt invites art enthusiasts,
          the curious, and newcomers to dive into a world of creativity and
          cultural heritage. Join us to discover, share, and celebrate the
          infinite richness of humanity through its artistic expressions.
        </p>
      </div>
    </section>
  );
